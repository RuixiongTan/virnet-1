...
//				pInfo.add(map_id);
			...
			button_semester.put("content", "< 学期管理  >");
			button_semester.put("class", "btn button-new");
			button_semester.put("id", "editTimeManagement");
			button_semester.put("click", "editTimeManagement(0);");
			...
			map.put("button_new", button_semester);
